...
smoke=replace_once(smoke,
    ...
    "  '__athleticsCalendarV2','__athleticsCompetitionJourneyV2','__athleticsScoutingV3','__athleticsStaffFinanceV2','__athleticsWorldSeasonV2','__athleticsRegression','AMLiveBroadcastV4','AMManagerCareerV1'\n",
