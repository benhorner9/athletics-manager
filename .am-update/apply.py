...
# Load biography authority immediately after the 64-nation world layer.
...
# Athlete profile: enrich on open and display DOB/place in the identity block.
...
# Staff profile: ensure the dossier has biography data and show it under age/approach.
...
# Static regression: require authority, load order and profile labels.
...
text=text.replace(old,new,1)
# Add profile-specific display contracts.
...
# Runtime smoke: biography authority must be active and every loaded athlete migrated.
