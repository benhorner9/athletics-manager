...
function renderContract(m){
 ...
 reader.querySelector('[data-open-athlete-contracts]')?.addEventListener('click',()=>{
  try{window.AMProgrammeEconomy?.openFinanceView?.('contracts')}catch(err){console.error('[Athletics Manager] Contract handoff failed',err);try{view('finance')}catch(_){} }
 });
