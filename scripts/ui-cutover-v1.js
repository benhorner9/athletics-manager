...
const BUILD='2026.09.13-commercialboard1';
const ROUTES={
...
function loadProgrammeEconomy(){
 if(!$('amProgrammeEconomyStyle')){const link=document.createElement('link');link.id='amProgrammeEconomyStyle';link.rel='stylesheet';link.href='styles/programme-economy-v1.css?v=20260913-commercialboard1';document.head.appendChild(link)}
 if(!$('amProgrammeEconomyScript')){const script=document.createElement('script');script.id='amProgrammeEconomyScript';script.src='scripts/programme-economy-v2.js?v=20260913-commercialboard1';script.async=false;document.body.appendChild(script)}
}
